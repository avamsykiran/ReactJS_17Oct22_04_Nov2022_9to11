...
import { deleteItemActionCreater,markItemEditableActionCreater} from '../state/InventoryReducer';
        ...
        <div className='row border-bottom border-secondary p-1'>
            ...
            <div className='col-sm-2'>
                ...
                <button className='btn btn-sm btn-danger' 
                    onClick={e => dispatch(deleteItemActionCreater(item.id))}>DELETE</button>
            </div>
        </div>
    );
};
